...
class producto {
	...
	{
			$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
			$consulta =$objetoAccesoDato->RetornarConsulta("select id as _id, codigo_de_barra as _codigo, nombre as _nombre,tipo as _tipo, stock as _stock, precio as _precio, fecha_de_creacion as _fechaCreacion, fecha_de_modificacion as _fechaModificacion from producto ORDER BY nombre $orden , tipo $orden ");
			$consulta->execute();			
    ...
    public function MostrarDatos(){
        ...
        return $this->_codigo.",".$this->_nombre.",".$this->_tipo.",".$this->_stock. ",".$this->_precio.",".$this->_fechaCreacion. ",".$this->_fechaModificacion . "<br>";
     }
}
